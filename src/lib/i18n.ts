...
const messages: Record<SupportedLanguage, MessageCatalog> = {
  "en-US": {
    ...
    "Create a passphrase for this full encrypted backup": "Create a passphrase for this full encrypted backup",
    "Enter the backup passphrase": "Enter the backup passphrase",
    Passphrase: "Passphrase", Continue: "Continue", "A passphrase is required.": "A passphrase is required.",
    "The passphrase is used only for this backup operation and is never saved.": "The passphrase is used only for this backup operation and is never saved.",
    "Please select an auth.json file": "Please select an auth.json file",
    "No file selected": "No file selected",
    "Clipboard unavailable. Copy the link manually.": "Clipboard unavailable. Copy the link manually.",
    "Clipboard unavailable. Please copy manually.": "Clipboard unavailable. Please copy manually.",
    "OAuth login must finish on the same host machine because the callback redirects to `localhost`.": "OAuth login must finish on the same host machine because the callback redirects to `localhost`.",
    "Imported {{imported}}, skipped {{skipped}} (total {{total}})": "Imported {{imported}}, skipped {{skipped}} (total {{total}})",
    "Open Codex failed: {{error}}": "Open Codex failed: {{error}}",
    "Switch failed: {{error}}": "Switch failed: {{error}}",
    "Could not save preference: {{error}}": "Could not save preference: {{error}}",
    "Could not save close preference: {{error}}": "Could not save close preference: {{error}}",
    "Close failed: {{error}}": "Close failed: {{error}}",
    "Switched account after {{action}} Codex.": "Switched account after {{action}} Codex.",
    "Account switched. Codex desktop reopened.": "Account switched. Codex desktop reopened.",
    "Codex desktop reopened.": "Codex desktop reopened.",
    "Codex closed and account switched, but reopening failed: {{error}}": "Codex closed and account switched, but reopening failed: {{error}}",
    "Codex closed, but reopening failed: {{error}}": "Codex closed, but reopening failed: {{error}}",
    "No closed desktop app could be identified for reopening. Open Codex manually.": "No closed desktop app could be identified for reopening. Open Codex manually.",
    "Switch failed after closing Codex: {{error}}": "Switch failed after closing Codex: {{error}}",
    "Could not verify that Codex closed. Account switching and reopening were skipped.": "Could not verify that Codex closed. Account switching and reopening were skipped.",
    "No running Codex processes found.": "No running Codex processes found.",
    "Force closed {{count}} Codex session(s).": "Force closed {{count}} Codex session(s).",
    "Closed {{count}} Codex session(s).": "Closed {{count}} Codex session(s).",
    "Force closed {{closed}}/{{total}} Codex sessions. {{remaining}} still running.": "Force closed {{closed}}/{{total}} Codex sessions. {{remaining}} still running.",
    "Closed {{closed}}/{{total}} Codex sessions. {{remaining}} still running.": "Closed {{closed}}/{{total}} Codex sessions. {{remaining}} still running.",
    "Could not {{action}} {{count}} Codex session(s).": "Could not {{action}} {{count}} Codex session(s).",
    "Unknown error": "Unknown error",
    "Enter the Codex Switcher web secret": "Enter the Codex Switcher web secret",
    "1 reset": "1 reset", "{{count}} resets": "{{count}} resets", "no expiry": "no expiry",
    "expiry unavailable": "expiry unavailable", "closest {{value}}": "closest {{value}}",
    "Click for expiry details": "Click for expiry details", "Reset credit expiry details": "Reset credit expiry details",
    "Available resets": "Available resets", "Reset {{count}}": "Reset {{count}}", "Expires {{value}}": "Expires {{value}}",
    "Times shown in your local time": "Times shown in your local time",
    "Codex usage stats via ChatGPT backend": "Codex usage stats via ChatGPT backend",
    "30d": "30d", "3 mo": "3 mo", "6 mo": "6 mo", "{{value}}% left": "{{value}}% left",
    "Remove {{value}}": "Remove {{value}}",
    "just now": "just now",
    "{{count}}s": "{{count}}s", "{{count}}m": "{{count}}m", "{{count}}h": "{{count}}h", "{{count}}d": "{{count}}d",
  },
  "zh-CN": {
    ...
    "Create a passphrase for this full encrypted backup": "为此完整加密备份创建口令",
    "Enter the backup passphrase": "输入备份口令",
    Passphrase: "口令", Continue: "继续", "A passphrase is required.": "必须输入口令。",
    "The passphrase is used only for this backup operation and is never saved.": "口令仅用于本次备份操作，不会被保存。",
    ...
    "OAuth login must finish on the same host machine because the callback redirects to `localhost`.": "OAuth 登录必须在同一台主机上完成，因为回调会重定向到 `localhost`。",
    "Imported {{imported}}, skipped {{skipped}} (total {{total}})": "已导入 {{imported}} 个，跳过 {{skipped}} 个（共 {{total}} 个）",
    "Open Codex failed: {{error}}": "打开 Codex 失败：{{error}}",
    "Switch failed: {{error}}": "切换失败：{{error}}",
    "Could not save preference: {{error}}": "无法保存偏好：{{error}}",
    "Could not save close preference: {{error}}": "无法保存关闭偏好：{{error}}",
    "Close failed: {{error}}": "关闭失败：{{error}}",
    "Switched account after {{action}} Codex.": "{{action}} Codex 后已切换账号。",
    "Account switched. Codex desktop reopened.": "账号已切换，Codex 桌面应用已重新打开。",
    "Codex desktop reopened.": "Codex 桌面应用已重新打开。",
    "Codex closed and account switched, but reopening failed: {{error}}": "Codex 已关闭并切换账号，但重新打开失败：{{error}}",
    "Codex closed, but reopening failed: {{error}}": "Codex 已关闭，但重新打开失败：{{error}}",
    "No closed desktop app could be identified for reopening. Open Codex manually.": "无法识别可重新打开的已关闭桌面应用，请手动打开 Codex。",
    "Switch failed after closing Codex: {{error}}": "关闭 Codex 后切换失败：{{error}}",
    "Could not verify that Codex closed. Account switching and reopening were skipped.": "无法确认 Codex 已关闭，已跳过账号切换和重新打开。",
    "No running Codex processes found.": "未找到正在运行的 Codex 进程。",
    "Force closed {{count}} Codex session(s).": "已强制关闭 {{count}} 个 Codex 会话。",
    "Closed {{count}} Codex session(s).": "已关闭 {{count}} 个 Codex 会话。",
    "Force closed {{closed}}/{{total}} Codex sessions. {{remaining}} still running.": "已强制关闭 {{closed}}/{{total}} 个 Codex 会话，仍有 {{remaining}} 个在运行。",
    "Closed {{closed}}/{{total}} Codex sessions. {{remaining}} still running.": "已关闭 {{closed}}/{{total}} 个 Codex 会话，仍有 {{remaining}} 个在运行。",
    "Could not {{action}} {{count}} Codex session(s).": "无法{{action}}{{count}} 个 Codex 会话。",
    "Unknown error": "未知错误",
    "Enter the Codex Switcher web secret": "输入 Codex Switcher Web 密钥",
    "1 reset": "1 个重置额度", "{{count}} resets": "{{count}} 个重置额度", "no expiry": "无过期时间",
    "expiry unavailable": "无法获取过期时间", "closest {{value}}": "最近一次 {{value}}",
    "Click for expiry details": "点击查看过期详情", "Reset credit expiry details": "重置额度过期详情",
    "Available resets": "可用重置额度", "Reset {{count}}": "重置额度 {{count}}", "Expires {{value}}": "过期时间：{{value}}",
    "Times shown in your local time": "时间按本地时区显示",
    "Codex usage stats via ChatGPT backend": "通过 ChatGPT 后端获取的 Codex 用量统计",
    "30d": "30 天", "3 mo": "3 个月", "6 mo": "6 个月", "{{value}}% left": "剩余 {{value}}%",
    "Remove {{value}}": "移除 {{value}}",
    "just now": "刚刚",
    "{{count}}s": "{{count}} 秒", "{{count}}m": "{{count}} 分钟", "{{count}}h": "{{count}} 小时", "{{count}}d": "{{count}} 天",
  },
};
